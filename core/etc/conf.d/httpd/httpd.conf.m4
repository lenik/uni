...
# with ServerRoot set to "APACHE_HOME" will be interpreted by the
# server as "APACHE_HOME/logs/foo.log".
#
...
#
ServerAdmin webmaster@bodz.net
...
#
# "APACHE_HOME/cgi-bin" should be changed to whatever your ScriptAliased
