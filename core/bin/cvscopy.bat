@echo off
rem $Id: cvscopy.bat,v 1.4 2005-06-19 08:28:16 dansei Exp $
...
rem 4, Update .sync-cvscopy-%mod%.bat file
	...
	echo rem CVSCOPY-Rev: $Revision: 1.4 $	>>.sync-cvscopy-%CC_NAME%.bat
...
:help
	...
	echo Written by Snima Denik, Update $Date: 2005-06-19 08:28:16 $
	echo Syntax
