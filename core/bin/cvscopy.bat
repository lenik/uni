@echo off
rem $Id: cvscopy.bat,v 1.5 2005-06-19 08:31:43 dansei Exp $
...
rem 4, Update .sync-cvscopy-%mod%.bat file
	...
	echo rem CVSCOPY-Rev: $Revision: 1.5 $	>>.sync-cvscopy-%CC_NAME%.bat
...
:help
	...
	echo Written by Snima Denik, Update $Date: 2005-06-19 08:31:43 $
	echo Syntax
