@echo off
rem $Id: cvscopy.bat,v 1.9 2005-07-14 02:30:53 dansei Exp $
...
rem 3, update .sync-cvscopy-%mod%.bat file
    ...
    echo @echo off                >.sync-cvscopy-%_base%.bat
    echo rem CVSCOPY-Rev: $Revision: 1.9 $    >>.sync-cvscopy-%_base%.bat
    echo rem Thie file is auto generated by CVSCOPY Program, and it will >>.sync-cvscopy-%_base%.bat
    echo rem be automaticly updated. Please don't edit this file. >>.sync-cvscopy-%_base%.bat
    echo %_copy_for_retry%            >>.sync-cvscopy-%_base%.bat
...
:help
    ...
    echo Written by Snima Denik, Update $Date: 2005-07-14 02:30:53 $
    echo Syntax
    echo     cvscopy
    echo       -d (cvsroot)
    echo       -o (cvs options)
