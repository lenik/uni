@echo off
rem $Id: cvscopy.bat,v 1.11 2006-03-17 07:49:31 dansei Exp $
...
rem 3, update .sync file
    ...
    echo rem CVSCOPY-Rev: $Revision: 1.11 $ >>%_syncfile%
...
:help
    ...
    echo Written by Snima Denik, Update $Date: 2006-03-17 07:49:31 $
    echo Syntax
    echo     cvscopy
    echo       -d (cvsroot)
    echo       -o (cvs options)
