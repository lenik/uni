@echo off
    ...
    rem Generated by Mkbat 0.1.784.784, 2008-01-15
    rem Template: Mkbat.batTemplate
...
:init
    ...
    set      _nam=net.bodz.lapiota.gui.GChoice
    set     _namf=%_nam:.=\%
    set      _ext=
    set _javaopts=%JAVA_OPTS% -Dcli.lib_loaded=1 net.bodz.lapiota.wrappers.LoadByLauncher net.bodz.bas.loader.BundledLoader
...
:initcp
    ...
    call :load "bodz_swt" "net.bodz.swt.jar"
    call :load "bodz_icons" "net.bodz.icons.jar"
