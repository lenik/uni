@echo off
    ...
    rem Generated by GenerateProgramLauncher 0.1.784, 2008-01-15
    rem Template: GenerateProgramLauncher.batTemplate
...
:init
    ...
    set      _nam=net.bodz.lapiota.filesys.PackageFragmentsProcess
    set     _namf=%_nam:.=\%
    set      _ext=
...
:initcp
    ...
    call :load "dom4j" "dom4j-1.6.1.jar"
    call :load "jaxen" "jaxen-1.1-beta-6.jar"
