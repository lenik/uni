...
:init
    ...
    set      _nam=com.lapiota.devhelpers.WinEdit
    set     _namf=%_nam:.=\%
    set      _ext=
    set _javaopts=%JAVA_OPTS% net.bodz.bas.loader.DefaultBooter -l bodz_swt -l bodz_icons -l bodz_jna -l jna --
