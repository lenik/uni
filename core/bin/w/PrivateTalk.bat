@echo off
    ...
    rem Generated by GenerateLauncher 0.1.784.784, 2008-01-15
    rem Template: GenerateLauncher.batTemplate
...
:init
    ...
    set     _namf=%_nam:.=\%
    set      _ext=
    set _javaopts=%JAVA_OPTS% -Dcli.lib_loaded=1 net.bodz.lapiota.wrappers.JavaLauncher
...
:initcp
    for %%f in (loadlib.bat) do set has_%%~nf=1
