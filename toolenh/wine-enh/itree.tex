\begin{tikzpicture}[
    ...
    child{
        ...
        child{
            ...
            child{ node[executable] {exe-runner\fileflag{*}} }
            child{ node[executable] {install-exe\fileflag{*}} }
        }
        child[missing] {}
        child[missing] {}
        child{
            ...
            child{
                node[dir] {binfmts\fileflag{/}}
                child{ node[plain] {wine-enh} }
            }
            child[missing] {}
            child{
                node[dir] {setup\fileflag{/}}
                child{
                    node[dir] {wine-enh\fileflag{/}}
