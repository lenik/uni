...
public class JavaShell extends BasicCLI {
    ...
    @Option(alias = "c", vnam = "SCRIPT", doc = "script file to run")
    File       script;
    String[]   scriptArgs;

    @Option(vnam = "CHARSET", doc = "script file encoding")
    ...
    @Option(alias = "E", vnam = "NAM=VAL", valtype = String.class, doc = "init environ")
    TextMap<Object>   env;
    ...
    @Override
    protected synchronized void doMain(String[] scriptArgs) throws IOException {
        ...
        while (true) {
            ...
            try {
                CatchExit.run(new RunnableThrows<Exception>() {
                    @Override
    ...
    abstract class BuiltIn extends _Command {
