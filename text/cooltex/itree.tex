\begin{tikzpicture}[
    ...
    child{
        ...
        child{
            ...
            child{ node[executable] {cooltex\fileflag{*}} }
            child{ node[executable] {pdfmon\fileflag{*}} }
            child{ node[executable] {treetex\fileflag{*}} }
        }
        child[missing] {}
        child[missing] {}
        child[missing] {}
