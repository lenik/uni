\begin{tikzpicture}[
    ...
    child{
        ...
        child{
            ...
            child{ node[plain] {cd-tree.sh} }
        }
        child[missing] {}
        child{
            node[dir] {bash\_completion.d\fileflag{/}}
            child{ node[plain] {cd-tree} }
        }
    }
    child[missing] {}
    child[missing] {}
    ...
    child{
        ...
        child{
            ...
            child{ node[executable] {cd-tree\fileflag{*}} }
            child{ node[executable] {tree-index\fileflag{*}} }
            child{ node[executable] {xf-tree\fileflag{*}} }
        }
        child[missing] {}
        child[missing] {}
        child[missing] {}
