    ...
    child{
        ...
        child{
            ...
            child{
                ...
                child{ node[executable] {catz\fileflag{*}} }
                child{ node[executable] {unzip-utf8\fileflag{*}} }
                child{ node[executable] {z+ls\fileflag{*}} }
                child{ node[executable] {z+ls-R\fileflag{*}} }
            }
            child[missing] {}
            child[missing] {}
            child[missing] {}
