...
export const links = {
    ...
    "FontAwesomeGalleryDemo": "component FontAwesomeGalleryDemo",
    "CgiDemo": 'CGI utils',
    ...
    "ToolBarDemo": 'ToolBar/toolitem demo',
...
export const routes = [
    ...
    { path: '/FontAwesomeGalleryDemo', component: () => import('./demo/FontAwesomeGalleryDemo.vue') },
    ...
    { path: '/ToolBarDemo', component: () => import('./input/ToolBarDemo.vue') },
