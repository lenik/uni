...
<template>
    <div class="component-root" ref="rootElement">
        <ul>
            <li>
                <FieldRow label="date" v-model="date">
            ...
            <li>
                <FieldRow label="local-str" v-model="localStr">
            ...
            <li>
                <FieldRow label="zoned-str" v-model="zonedStr">
            ...
            <li>
                <FieldRow label="offset-str" v-model="offsetStr">
            ...
            <li>
                <FieldRow label="temporal / instant" v-model="instant">
            ...
            <li>
                <FieldRow label="temporal / localDate" v-model="localDate">
            ...
            <li>
                <FieldRow label="Datetemporal / localDateTime" v-model="localDateTime">
            ...
            <li>
                <FieldRow label="temporal / localTime" v-model="localTime">
            ...
            <li>
                <FieldRow label="temporal / offsetDateTime" v-model="offsetDateTime">
            ...
            <li>
                <FieldRow label="temporal / offsetTime" v-model="offsetTime">
            ...
            <li>
                <FieldRow label="temporal / zonedDateTime" v-model="zonedDateTime">
