...
:init
    ...
    set      _nam=net.bodz.uni.win32.jawin.Hello
    set     _namf=%_nam:.=\%
    set      _ext=
    set _javaopts=%JAVA_OPTS% net.bodz.bas.loader.DefaultBooter -l %%project --
...
:initcp
    ...
    call :load "lapiota_tools" "net.bodz.uni.tools.jar"
