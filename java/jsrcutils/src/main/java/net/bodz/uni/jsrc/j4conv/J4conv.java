package net.bodz.uni.jsrc.j4conv;
...
import net.bodz.uni.c.jdt.ASTUtils;
import net.bodz.uni.c.jdt.ASTVisitor2;
import net.bodz.uni.c.jdt.JavaUtil;
import net.bodz.uni.c.jdt.JdtBatchCLI;
...
public class J4conv
    ...
    public void processFile(FileHandler handler)
        ...
        out.to(StreamWriting.class).writeString(dst);
