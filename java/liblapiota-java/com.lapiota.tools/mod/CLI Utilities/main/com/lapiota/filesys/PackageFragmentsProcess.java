...
public class PackageFragmentsProcess extends BatchEditCLI {
    ...
    static interface Action extends CLIPlugin {
        ...
        void doDirectoryArg(File dir) throws Exception;

        void doJarArg(JarFile jar) throws Exception;
    ...
    class Lister extends _Action {
        ...
        @Override
        public void doDirectoryArg(File dir) throws Exception {
        ...
        @Override
        public void doJarArg(JarFile jar) throws Exception {
    ...
    abstract class _EntryAction extends _Action {
        ...
        public void doDirectoryEntry(File file) throws Exception {
        ...
        public void doJarEntry(JarFile jar, JarEntry entry) throws Exception {
